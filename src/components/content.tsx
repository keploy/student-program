...
const Content = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 -mt-30">
      <h1 className="text-xl sm:text-4xl md:text-5xl lg:text-6xl text-primary-400 font-medium leading-tight sm:leading-tight md:leading-tighter place-self-center tracking-tighter mb-4 md:mt-4 lg:mt-5">
