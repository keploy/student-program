    ...
    >
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="header-btn-container flex-grow-0 w-4/12 justify-end hidden sm:flex">
          <div className="rounded-full overflow-hidden p-2.5 border-opacity-40 relative transition-all  group">
              ...
              >
                ...
                <span className="text-base flex gap-1">
                     <CountingNumbers className="text-black font-bold" />
                     </span>
              </Link>
            </div>
